...
out vec3 varyingNormal, varyingLightDir, varyingLight1Dir, varyingVertPos, varyingHalfVec, varyingHalfVec1; 
...
{	//output the vertex position to the rasterizer for interpolation
	...
	varyingLight1Dir = light1.position - varyingVertPos;
	...
	varyingHalfVec1 = (varyingLight1Dir-varyingVertPos).xyz;
